...
const codeExamples = [
    {
        ...
        code: `def assign_grade(score: int) -> str:
    """
...
print(f"59 -> {assign_grade(59)}")`
    ...
    {
        title: "2. Character Repeater",
        code: `def repeat_chars(text: str, n: int) -> str:
    """
...
print(f"'Hi', 2 -> {repeat_chars('Hi', 2)}")`
    ...
    {
        title: "3. Find First Occurrence",
        code: `def find_first(items: list, target) -> int:
    """
...
print(f"[1, 2, 3], 4 -> {find_first([1, 2, 3], 4)}")`
    ...
    {
        title: "4. String Property Checker",
        code: `def validate_string(text: str) -> bool:
    """
...
print(f"'wonderful' -> {validate_string('wonderful')}")`
    ...
    {
        title: "5. Filter List by Length",
        code: `def filter_by_length(words: list[str], min_length: int) -> list[str]:
    """
...
print(filter_by_length(["apple", "cat", "banana", "dog", "elephant"], 5))`
    ...
    {
        title: "6. Sum of String Digits",
        code: `def sum_digits(number_str: str) -> int:
    """
...
print(f"'1928' -> {sum_digits('1928')}")`
    ...
    {
        title: "7. Extract Seniors from Tuple Data",
        code: `def get_seniors(people: list[tuple]) -> list[str]:
    """
...
print(get_seniors(people_data))`
    ...
    {
        title: "8. Invert Dictionary",
        code: `def invert_mapping(mapping: dict) -> dict:
    """
...
print(invert_mapping({'a': 'z', 'b': 'y', 'c': 'x'}))`
    ...
    {
        title: "9. Sort Rectangles by Area",
        code: `def sort_rectangles_by_area(rectangles: list[dict]) -> list[dict]:
    """
...
print(sort_rectangles_by_area(rects))`
    ...
    {
        title: "10. Find Missing Sequence Numbers",
        code: `def find_missing(nums: list[int], n: int) -> set:
    """
...
print(find_missing([1, 2, 5, 6], 8))`
    ...
    {
        title: "11. Count Words Excluding Stopwords",
        code: `def count_frequent_words(text: str, stopwords: set[str]) -> dict:
    """
...
print(doc.get_info())`
    ...
    {
        title: "16. Polymorphic Logger",
        code: `def process_logs(loggers: list, message: str):
    """
